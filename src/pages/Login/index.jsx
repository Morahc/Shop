...
const Login = () => {
  ...
  return (
    <div className="container bg-background flex flex-col justify-center items-center min-h-full h-screen space-y-3 lg:space-y-6">
      ...
      <div className="bg-white flex flex-col items-center border rounded-sm w-full md:w-1/4 p-6">
